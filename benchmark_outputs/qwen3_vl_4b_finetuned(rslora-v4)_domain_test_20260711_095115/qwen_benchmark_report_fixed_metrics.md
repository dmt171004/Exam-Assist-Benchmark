...
|---|---:|
| Answerable EM | 12.69% |
| Answerable Token F1 | 66.85% |
| Answerable ROUGE-L | 65.19% |
| Containment Accuracy | 42.13% |
...
|---|---:|
| Overall EM | 19.53% |
| Overall Token F1 | 69.16% |
| Overall ROUGE-L | 67.64% |
| Average Latency | 0.0286 sec/sample |
| Throughput | 34.98 samples/sec |
