...
|---|---:|
| Answerable EM | 12.94% |
| Answerable Token F1 | 67.72% |
| Answerable ROUGE-L | 66.23% |
| Containment Accuracy | 44.92% |
| False Refusal Rate | 3.30% |
...
|---|---:|
| Overall EM | 19.77% |
| Overall Token F1 | 69.96% |
| Overall ROUGE-L | 68.59% |
| Average Latency | 0.0284 sec/sample |
| Throughput | 35.21 samples/sec |
