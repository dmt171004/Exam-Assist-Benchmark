...
|---|---:|
| Answerable EM | 11.93% |
| Answerable Token F1 | 63.76% |
| Answerable ROUGE-L | 62.48% |
| Containment Accuracy | 40.36% |
...
|---|---:|
| Overall EM | 18.84% |
| Overall Token F1 | 66.32% |
| Overall ROUGE-L | 65.16% |
| Average Latency | 0.0282 sec/sample |
| Throughput | 35.44 samples/sec |
